...
function user_job_setup()
    ...
    state.WeaponskillMode:options('Match', 'Normal', 'DT', 'SomeAcc', 'Acc',
                                  'FullAcc', 'Fodder', 'Proc')
    state.IdleMode:options('Normal', 'Sphere')
    state.PhysicalDefenseMode:options('PDT')
    state.MagicalDefenseMode:options('MDT')
    state.ResistDefenseMode:options('MEVA')
    state.Weapons:options('Evisceration', 'Treasure', 'Currency')
    ...
    gear.da_jse_back = { name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Crit.hit rate+10','Phys. dmg. taken-10%',}}
    -- name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}}
    gear.wsd_jse_back = { name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Crit.hit rate+10','Phys. dmg. taken-10%',}}
    -- name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
    ...
    state.Weapons:set('Evisceration')
end
...
function init_gear_sets()
    ...
    -- hands="Plunderer's Armlets +1",waist="Chaac Belt",feet="Skulk. Poulaines +1"}
    sets.Kiting = {feet="Plun. Poulaines +3"}
    -- feet="Skd. Jambeaux +1"}
    ...
    sets.weapons.Evisceration = {main = "Tauret", sub = "Odium"}
    sets.weapons.Treasure = {main = "Tauret", sub = "Odium"}
    sets.weapons.Currency = {main = "Mercurial Kris", sub = "Thief's Knife"}
    sets.weapons.Throwing = {}
    sets.weapons.SwordThrowing = {}
    sets.weapons.Bow = {}

    -- sets.weapons.Aeneas = {main="Aeneas",sub="Gleti's Knife"}
    sets.weapons.Aeolian = {main = "Tauret"}
    ...
    sets.precast.WS['Aeolian Edge'].TH = set_combine(
                                             sets.precast.WS['Aeolian Edge'],
                                             sets.TreasureHunter)
    ...
    sets.AccMaxTP = {}
    -- ear1="Mache Earring +1",ear2="Sherida Earring"}
    ...
    sets.midcast.Diaga = set_combine(sets.midcast.FastRecast,
                                     sets.TreasureHunter)
    sets.midcast['Dia II'] = set_combine(sets.midcast.FastRecast,
                                         sets.TreasureHunter)
    sets.midcast.Bio = set_combine(sets.midcast.FastRecast, sets.TreasureHunter)
    sets.midcast['Bio II'] = set_combine(sets.midcast.FastRecast,
                                         sets.TreasureHunter)
