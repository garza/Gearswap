function user_job_setup()
	...
	state.Weapons:options('Tiznaeg', 'Tizzan')

    state.ExtraMeleeMode = M{['description']='Extra Melee Mode','None','MP','SuppaBrutal','DWEarrings','DWMax'}
    state.UndeadMode = M(false, 'Undead Mode')

	gear.da_jse_back = {name="Rosmerta's Cape",augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	gear.stp_jse_back = {name="Rosmerta's Cape",augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	gear.crit_jse_back = {name="Rosmerta's Cape",augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	...
	gear.nuke_jse_back = {name="Rosmerta's Cape",augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
...
function init_gear_sets()
	...
	sets.buff.Doom = set_combine(sets.buff.Doom, {left_ring="Eshmun's Ring", right_ring="Eshmun's Ring",})
	...
	sets.precast.FC = {main="Vampirism",sub="Sakpata's Sword",ammo="Impatiens",
		...
		body="Luhlaza Jubbah +3",hands="Hashi. Bazu. +1",ring1="Kishar Ring",ring2="Lebeche Ring",
	...
	sets.precast.WS = {ammo="Aurgelmir Orb +1",
                  ...
                  body="Adhemar Jacket +1",hands="Assim. Bazu. +4",ring1="Epona's Ring",ring2="Apate Ring",
	...
	sets.precast.WS.Acc = {ammo="Falcon Eye",
				  ...
				  body="Assim. Jubbah +4",hands="Assim. Bazu. +4",ring1="Epona's Ring",ring2="Ilabrat Ring",
	...
	sets.precast.WS['Expiacion'].Acc = set_combine(sets.precast.WS.Acc, {neck="Mirage Stole +2",ear1="Moonshade Earring",body="Assim. Jubbah +4",hands="Jhakri Cuffs +2",back=gear.wsd_jse_back,legs="Luhlaza Shalwar +3",feet=gear.herculean_wsd_feet})
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Sequence",sub="Almace",ammo="Falcon Eye",
	    ...
	    body="Assim. Jubbah +4",hands="Malignance Gloves",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	sets.midcast['Blue Magic'].Physical.Fodder = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		...
		body="Assim. Jubbah +4",hands="Jhakri Cuffs +2",ring1="Ifrit Ring +1",ring2="Ilabrat Ring",
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {main="Sequence",sub="Almace",ammo="Falcon Eye",
		head="Jhakri Coronal +2",neck="Mirage Stole +2",ear1="Regal Earring",ear2="Telos Earring",
	    body="Assim. Jubbah +4",hands="Jhakri Cuffs +2",ring1="Ramuh Ring +1",ring2="Ilabrat Ring",
	...
	sets.midcast['Blue Magic'].Breath = {ammo="Mavi Tathlum",
		...
		body="Assim. Jubbah +4",hands="Luh. Bazubands +1",ring1="Kunaji Ring",ring2="Meridian Ring",
	...
	sets.midcast['Blue Magic'].Buff = {main="Vampirism",sub="Vampirism",ammo="Mavi Tathlum",
		...
		body="Assim. Jubbah +4",hands="Hashi. Bazu. +1",ring1="Kishar Ring",ring2="Dark Ring",
	...
	sets.resting = {main="Bolelabunga",sub="Genmei Shield",ammo="Falcon Eye",
			      head="Assim. Keffiyeh +4",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Jhakri Robe +2",hands=gear.herculean_refresh_hands,ring1="Defending Ring",ring2="Sheltered Ring",
			      back="Bleating Mantle",waist="Flume Belt +1",legs="Malignance Tights"}

	-- Idle sets
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
			      head="Assim. Keffiyeh +4",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Assim. Jubbah +4",hands=gear.herculean_refresh_hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
			      back="Umbra Cape",waist="Flume Belt +1",legs="Malignance Tights"}
	...
	-- sets.MagicBurst = {body="Samnuha Coat",hands="Amalric Gages +1",legs="Assim. Shalwar +4",ring1="Mujin Band",ring2="Locus Ring"}
...
autows_list = {['Tizzan']='Savage Blade',['Tiznaeg']='Chant du Cygne' }
